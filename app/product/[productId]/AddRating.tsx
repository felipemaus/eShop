...
const AddRating:React.FC<AddRatingProps> = ({product, user}) =>{
    ...
    return (
        <div className="flex flex-col gap-2 max-w-[500px]">
            ...
            <Input id="comment" label="Comentário" disabled={isLoading} register={register} errors={errors} required />
            <Button label={isLoading ? "Loading" : "RateProduct"} onClick={handleSubmit(onSubmit)} />
        </div>
    )
}
